<?php 
function base_url(){return 'http://burganic.com/projects/workflow/'}
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/build/rappid.min.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/css/layout.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/css/paper.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/css/inspector.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/css/navigator.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/css/stencil.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/css/halo.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/css/selection.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/css/toolbar.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/css/statusbar.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/css/freetransform.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>rappid/css/style.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>plugins/EasyAutocomplete-1.3.5/easy-autocomplete.min.css" />
		...
		.halo.surrounding .handle.eRemove {
			background: url("http://burganic.com/projects/workflow/rappid/img/delete.jpg") no-repeat !important ;
		...
		.halo.surrounding .handle.eAddport {
			background: url("http://burganic.com/projects/workflow/rappid/img/addport.jpg") no-repeat !important;
			background-size: contain !important;
			position: relative;
			height: 20px !important;
			width: 100px;
		...
		.halo.surrounding .handle.eConfigure {
			position: relative;
			background: url("http://burganic.com/projects/workflow/rappid/img/configure.jpg") no-repeat !important;
			background-size: contain !important;
		...
		ul.tag_list li input#tem_tags.loading{
			background: rgba(0, 0, 0, 0) url("http://burganic.com/projects/workflow/rappid/img/loading.gif") no-repeat scroll right center;
		}
    ...
    <body>
        ...
        <div class="toolbar-container">
			...
			<button id="btn-fullscreen" class="btn" data-tooltip="Toggle Fullscreen Mode" style="float: right;"><img src="<?php echo base_url();?>rappid/img/fullscreen.png" alt="Fullscreen"/></button>
            <button id="btn-zoom-to-fit" class="btn" data-tooltip="Zoom To Fit" style="float: right;"><img src="<?php echo base_url();?>rappid/img/zoomtofit.png" alt="Zoom To Fit"/></button>
            <button id="btn-zoom-in" class="btn" data-tooltip="Zoom In" style="float: right;"><img src="<?php echo base_url();?>rappid/img/zoomin.png" alt="Zoom in"/></button>
			...
			<button id="btn-zoom-out" class="btn" data-tooltip="Zoom Out" style="float: right;"><img src="<?php echo base_url();?>rappid/img/zoomout.png" alt="Zoom out"/></button>
        ...
        <!-- Dependencies: -->
        <script src="<?php echo base_url();?>rappid/node_modules/jquery/dist/jquery.js"></script>
        <script src="<?php echo base_url();?>rappid/node_modules/lodash/index.js"></script>
        <script src="<?php echo base_url();?>rappid/node_modules/backbone/backbone.js"></script>
        <script src="<?php echo base_url();?>rappid/node_modules/graphlib/dist/graphlib.core.js"></script>
        <script src="<?php echo base_url();?>rappid/node_modules/dagre/dist/dagre.core.js"></script>
        <script src="<?php echo base_url();?>rappid/lib/KeyboardJS/keyboard.js"></script>
        <script src="<?php echo base_url();?>rappid/build/rappid.min.js"></script>
        <script src="<?php echo base_url();?>rappid/src/inspector.js"></script>
        <script src="<?php echo base_url();?>rappid/src/stencil.js"></script>
        <script src="<?php echo base_url();?>rappid/src/main.js"></script>
